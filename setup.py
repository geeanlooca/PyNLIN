...
requirements = ["numpy", "scipy", "matplotlib", "h5py", "tqdm", "torch", "logging"]
dev_requirements = [
    "pylint",
    "autopep8",
    "flake8",
...
setup(
    ...
    description="A simulation package for the evaluation of nonlinear penalties in optical fiber transmission",  # Optional
    ...
    keywords="photonics fiber fibre optics simulation raman amplification nonlinearity tranmission nonlinear penalties",  # Optional
    ...
    # data_files=[('examples', ['examples/*,py'])],  # Optional
    ...
    #     'Bug Reports': 'https://gitlab.com/peg-dei/peg/issues',
    #     'Documentation': 'https://peg-dei.gitlab.io/peg',
    #     'Source': 'https://gitlab.com/peg-dei/peg/'
    # },
)
