...
fig_arity = fig_arity = plt.figure(figsize=(14, 6))
var_QAM = []
var_PSK = []
for m in m_QAM:
...
plt.annotate("{:1.3f}".format(var_QAM[3]/var_16_QAM), (256, var_QAM[3]/var_16_QAM-0.15))
plt.annotate("{:1.3f}".format(var_QAM[4]/var_16_QAM), (1024-200, var_QAM[4]/var_16_QAM-0.15))
