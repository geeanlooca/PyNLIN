...
for fiber_length in fiber_lengths:
    ...
    # OPTIMIZER COUNTER =================================
        ...
        if optimize:    
            ...
            np.save(optimization_result_path_coct+"opt_powers_ct"+str(power_per_channel_dBm)+".npy", pump_powers_ct)
        else: 
            pump_wavelengths_ct = np.load(optimization_result_path_coct+"opt_wavelengths_ct"+str(power_per_channel_dBm)+".npy")
            pump_powers_ct = np.load(optimization_result_path_coct+"opt_powers_ct"+str(power_per_channel_dBm)+".npy")
